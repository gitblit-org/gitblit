...
public class GitBlitTest extends GitblitUnitTest {
	...
	public void testRepositoryModel() throws Exception {
		...
		assertTrue(
				...
				repositories.contains(GitBlitTestConfig.getHelloworldRepository().getDirectory()
						.getName()));
		...
		assertEquals(GitBlitTestConfig.getHelloworldRepository().getDirectory().getName(), model.name);
	...
	public void testUserModel() throws Exception {
		...
		String repository = GitBlitTestConfig.getHelloworldRepository().getDirectory().getName();
