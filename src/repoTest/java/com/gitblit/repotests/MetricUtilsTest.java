...
public class MetricUtilsTest extends RepoUnitTest {

	@Test
	public void testMetrics() throws Exception {
		testMetrics(GitBlitTestConfig.getHelloworldRepository());
		testMetrics(GitBlitTestConfig.getJGitRepository());
	}
	...
	public void testAuthorMetrics() throws Exception {
		...
		repository.close();
		assertEquals("No author metrics found!", GitBlitTestConfig.helloworldSettings.getInteger(HelloworldKeys.users.byEmail, -1), byEmail.size());
		assertEquals("No author metrics found!", GitBlitTestConfig.helloworldSettings.getInteger(HelloworldKeys.users.byName, -1), byName.size());
	}
}
