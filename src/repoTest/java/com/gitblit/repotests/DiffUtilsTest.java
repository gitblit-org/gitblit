...
public class DiffUtilsTest extends RepoUnitTest {
	...
	public void testBlame() throws Exception {
		...
		assertEquals(GitBlitTestConfig.helloworldSettings.getRequiredString(HelloworldKeys.commit.first), lines.get(0).commitId);
	}
}
